...
// cek apakah ada bundle atau tidak
        if (getIntent().getExtras() != null) {
            ...
            tvID.setText(bundle.getString("idUserCuti"));
            TVnama.setText(bundle.getString("namaCuti"));
            TVjam_masuk.setText(bundle.getString("JamMasukCuti"));
            TVjam_keluar.setText(bundle.getString("JamKeluarCuti"));
            TVtanggal.setText(bundle.getString("tanggalCuti"));
            TVtanggal2.setText(bundle.getString("tanggalCuti"));
            tvStatus.setText(bundle.getString("statusCuti"));
            String statusData = bundle.getString("statusCuti");
        ...
        spinKeterangan.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (parent.getItemAtPosition(position).equals("Pilih Persetujuan")) {
                    ...
                    Toast.makeText(detail_cuti.this, "Pilih Tindakan", Toast.LENGTH_SHORT).show();
        ...
        btnSetuju.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (pilih == 0){
                    Toast.makeText(detail_cuti.this, "Harap Pilih Tindakan", Toast.LENGTH_SHORT).show();
                }else {
    ...
    private void approve(){
        ...
        update.enqueue(new Callback<LoginResponse>() {
            ...
            public void onResponse(Call<LoginResponse> call, Response<LoginResponse> response) {
                Toast.makeText(detail_cuti.this, "Berhasil "+status, Toast.LENGTH_SHORT).show();
            }
