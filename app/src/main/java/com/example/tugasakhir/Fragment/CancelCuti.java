...
public class CancelCuti extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.cancel_cuti_fragment,container,false);
        rvData = v.findViewById(R.id.rv_CancelCuti);
        srlData = v.findViewById(R.id.srl_dataCC);
        pbData = v.findViewById(R.id.pb_dataCC);
    ...
    private void load() {
        ...
        Call<List<DataDetail>> call = (Call<List<DataDetail>>) APIConfig.getService().ardTolakCuti();
        call.enqueue(new Callback<List<DataDetail>>() {
            ...
            public void onFailure(Call<List<DataDetail>> call, Throwable t) {
                Toast.makeText(getContext(), "Tidak ada daftar cuti yang ditolak hari ini", Toast.LENGTH_SHORT).show();
                pbData.setVisibility(View.INVISIBLE);
            }
        });
