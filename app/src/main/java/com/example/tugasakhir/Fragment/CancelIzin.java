...
public class CancelIzin extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rvData = v.findViewById(R.id.rv_CancelIzin);
        srlData = v.findViewById(R.id.srl_dataCI);
        pbData = v.findViewById(R.id.pb_dataCI);
    ...
    private void load() {
        ...
        Call<List<DataDetail>> call = (Call<List<DataDetail>>) APIConfig.getService().ardTolakIzin();
