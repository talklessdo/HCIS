...
public class ApproveSakit extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.approve_sakit_fragment,container,false);
        rvData = v.findViewById(R.id.rv_Sakit);
    ...
    private void load() {
        ...
        Call<List<DataDetail>> call = (Call<List<DataDetail>>) APIConfig.getService().ardSakit();
        call.enqueue(new Callback<List<DataDetail>>() {
            ...
            public void onFailure(Call<List<DataDetail>> call, Throwable t) {
                Toast.makeText(getContext(), "Tidak ada daftar sakit yang disetujui hari ini", Toast.LENGTH_SHORT).show();
                pbData.setVisibility(View.INVISIBLE);
            }
        });
