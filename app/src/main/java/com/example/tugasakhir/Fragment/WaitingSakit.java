...
public class WaitingSakit extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.waiting_sakit_fragment,container,false);
        rvData = v.findViewById(R.id.rv_Waitsakit);
    ...
    private void load() {
        ...
        Call<List<DataDetail>> call = (Call<List<DataDetail>>) APIConfig.getService().ardWaitSakit();
        call.enqueue(new Callback<List<DataDetail>>() {
            ...
            public void onFailure(Call<List<DataDetail>> call, Throwable t) {
                Toast.makeText(getContext(), "Tidak ada daftar sakit yang menunggu hari ini", Toast.LENGTH_SHORT).show();
                pbData.setVisibility(View.INVISIBLE);
            }
        });
